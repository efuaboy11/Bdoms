      ...
      <section id="cover-page">
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="d-block w-100 img1">
                <div class="cover-header">
                  ...
                  <Link to="/portal" class="btn btn-outline-danger btn-lg px-3 " data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000" >Login in</Link>
                </div>
              </div>
            </div>
            <div class="carousel-item">
              <div class="d-block w-100 img2">
                <div class="cover-header">
                  <h1 class="" data-aos-delay="" data-aos-duration="1000">EDUCATION IS KEY</h1>
            ...
            <div class="carousel-item">
              <div class="d-block w-100 img3">
                <div class="cover-header">
                  <h1 class="" data-aos-delay="" data-aos-duration="1000">KNOWLEGE IS POWER</h1>
                  ...
                  <div class="icon" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000" >
                    <a href="#" class="g-3"><i class="fa-brands fa-facebook text-primary1"></i></a> 
                    <a href="#" class="g-3"><i class="fa-brands fa-instagram text-primary1"></i></a>
                    <a href="#" class="g-3"><i class="fa-brands fa-whatsapp text-primary1"></i></a>
                  </div>
